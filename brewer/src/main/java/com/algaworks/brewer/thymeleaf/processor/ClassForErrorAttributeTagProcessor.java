...
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor{
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
		...
		if(temErro) {
			String classesExistentes = tag.getAttributeValue("class"); //Pega as classes com TAG class no HTML
			structureHandler.setAttribute("class", classesExistentes + " has-error"); //Pega tudo o que tem class e subtitui por classesExistentes + " has-error"
		}
